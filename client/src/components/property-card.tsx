    ...
    <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="p-4">
        <div className="flex justify-between items-start mb-2">
          <h3 className="text-lg font-heading font-semibold text-neutral-800 line-clamp-1">{property.title}</h3>
          <span className="text-primary font-bold">{property.price.toLocaleString()} FCFA</span>
        </div>
        ...
        <div className="flex items-center text-sm text-neutral-600 space-x-4 border-t border-neutral-200 pt-3">
